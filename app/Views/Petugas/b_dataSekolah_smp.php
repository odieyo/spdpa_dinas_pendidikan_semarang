                                ...
                                <div class="tab-content" id="custom-tabs-four-tabContent">
                                    ...
                                    <div class="tab-pane fade" id="custom-tabs-four-gurumatpel" role="tabpanel" aria-labelledby="custom-tabs-four-gurumatpel-tab" style="overflow-x:auto;">
                                        <table class="table table-bordered text-center" id="tabel_sekolah2">
                                            ...
                                            <tbody>
                                                <?php foreach ($sekolah as $skl) : ?>
                                                    <?php $gm =  $this->m_pegawai->hitungGuruPelajaran($skl['npsn']);  ?>
                                                    <tr>
                                                        <td><?= $i++ ?></td>
                                                        <td><?= $skl['nama_sekolah']; ?></td>
                                                        <td><?= $skl['guru_ipa']; ?></td>
                                                        ...
                                                        <td><?= $gm['ipaPPPK']; ?></td>
                                                        <td><?= $gm['ipaNonPNS']; ?></td>
                                                        <td><?= $skl['guru_ipa'] + $gm['ipaPNS'] + $gm['ipaPPPK'] + $gm['ipaNonPNS']; ?></td>
                                                        <td><?= $skl['guru_ips']; ?></td>
                                                        <td><?= $gm['ipsPNS']; ?></td>
                                                        <td><?= $gm['ipsPPPK']; ?></td>
                                                        <td><?= $gm['ipsNonPNS']; ?></td>
                                                        <td><?= $gm['ipsPNS'] + $gm['ipsPPPK'] + $gm['ipsNonPNS'] - $skl['guru_ips']; ?></td>
                                                        <td><?= $skl['guru_senbud']; ?></td>
                                                        <td><?= $gm['senPNS']; ?></td>
                                                        <td><?= $gm['senPPPK']; ?></td>
                                                        <td><?= $gm['senNonPNS']; ?></td>
                                                        <td><?= $gm['senPNS'] + $gm['senPPPK'] + $gm['senNonPNS'] - $skl['guru_senbud']; ?></td>
                                                        <td><?= $skl['guru_tik']; ?></td>
                                                        <td><?= $gm['tikPNS']; ?></td>
                                                        <td><?= $gm['tikPPPK']; ?></td>
                                                        <td><?= $gm['tikNonPNS']; ?></td>
                                                        <td><?= $gm['tikPNS'] + $gm['tikPPPK'] + $gm['tikNonPNS'] - $skl['guru_tik']; ?></td>
                                                        <td><?= $skl['guru_pkn']; ?></td>
                                                        <td><?= $gm['pknPNS']; ?></td>
                                                        <td><?= $gm['pknPPPK']; ?></td>
                                                        <td><?= $gm['pknNonPNS']; ?></td>
                                                        <td><?= $gm['pknPNS'] + $gm['pknPPPK'] + $gm['pknNonPNS'] - $skl['guru_pkn']; ?></td>
                                                        <td><?= $skl['guru_indo']; ?></td>
                                                        <td><?= $gm['indPNS']; ?></td>
                                                        <td><?= $gm['indPPPK']; ?></td>
                                                        <td><?= $gm['indNonPNS']; ?></td>
                                                        <td><?= $gm['indPNS'] + $gm['indPPPK'] + $gm['indNonPNS'] - $skl['guru_indo']; ?></td>
                                                        <td><?= $skl['guru_eng']; ?></td>
                                                        <td><?= $gm['engPNS']; ?></td>
                                                        <td><?= $gm['engPPPK']; ?></td>
                                                        <td><?= $gm['engNonPNS']; ?></td>
                                                        <td><?= $gm['engPNS'] + $gm['engPPPK'] + $gm['engNonPNS'] - $skl['guru_eng']; ?></td>
                                                        <td><?= $skl['guru_mat']; ?></td>
                                                        <td><?= $gm['matPNS']; ?></td>
                                                        <td><?= $gm['matPPPK']; ?></td>
                                                        <td><?= $gm['matNonPNS']; ?></td>
                                                        <td><?= $gm['matPNS'] + $gm['matPPPK'] + $gm['matNonPNS'] - $skl['guru_mat']; ?></td>
                                                    </tr>
                                                <?php endforeach; ?>
                                            </tbody>
                                        </table>
                ...
                <div class="modal-body">
                    <div class="col">
                        <div class="custom-file">
                            ...
                            <input type="hidden" class="custom-file-input" id="jenjang" name="jenjang" value="SMP">
                            <label for="csvSekolah" class="custom-file-label">Pilih Berkas</label>
                        </div>
                    </div>
                    <div class="col" style="margin-top: 10px;">
                        <a href="/template_sekolah_smp.xlsx">Unduh Template (Data SMP.xlsx)</a>
                    </div>
