                    ...
                    <div class="card card-success">
                        ...
                        <div class="card-body">
                            <?php foreach ($pegawai as $pgw) : ?>
                                <form action="/petugas/update/<?= $pgw['nik']; ?>" method="post">
                                    <?= csrf_field(); ?>
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col">
                                                <label for="nik">NIK</label>
                                                <input type="text" id="nik" class="form-control" name="nik" value="<?= (old('nik')) ? old('nik') : $pgw['nik']; ?>">
                                            </div>
                                            <div class="col">
                                                <label for="nama_pegawai">Nama Pegawai</label>
                                                <input type="text" id="nama_pegawai" class="form-control" name="nama_pegawai" value="<?= (old('nama_pegawai')) ? old('nama_pegawai') : $pgw['nama_pegawai']; ?>">
                                            </div>
                                            <div class=" col">
                                                <label for="nip">NIP</label>
                                                <input type="text" id="nip" class="form-control" name="nip" value="<?= (old('nip')) ? old('nip') : $pgw['nip']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <input type="option" id="jenis_jabatan" class="form-control" name="jenis_jabatan" value="<?= $pgw['jenis_jabatan']; ?>">
                                            </div>
                                            <div class=" col">
                                                <label for="tugas_tambahan">Tugas Tambahan</label>
                                                <input type="option" id="tugas_tambahan" class="form-control" name="tugas_tambahan" value="<?= $pgw['tugas_tambahan']; ?>">
                                            </div>
                                            <div class=" col">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                ...
                                                <input type="text" id="tempat_lahir" class="form-control" name="tempat_lahir" value="<?= $pgw['tempat_lahir']; ?>">
                                            </div>
                                            <div class=" col">
                                                <label for="tanggal_lahir">Tanggal Lahir</label>
                                                <input type="date" id="tanggal_lahir" class="form-control" name="tanggal_lahir" value="" placeholder="dd-mm-yyyy" value="<?= $pgw['tanggal_lahir']; ?>">
                                            </div>
                                            <div class=" col">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <input type="text" id="nuptk" class="form-control " name="nuptk" value="<?= $pgw['nuptk']; ?>">
                                            </div>
                                            <div class="col">
                                                <label for="no_pes_sertif">Nomor Peserta Sertifikat</label>
                                                <input type="text" id="no_pes_sertif" class="form-control " name="no_pes_sertif" value="<?= $pgw['no_pes_sertif']; ?>">
                                            </div>
                                            <div class="col">
                                                <label for="nrg">NRG</label>
                                                <input type="text" id="nrg" class="form-control " name="nrg" value="<?= $pgw['nrg']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                ...
                                                <input type="text" id="jurusan" class="form-control " name="jurusan" value="<?= $pgw['jurusan']; ?>">
                                            </div>
                                            <div class="col">
                                                <label for="no_hp">Nomor Handphone</label>
                                                <input type="text" id="no_hp" class="form-control " name="no_hp" value="<?= $pgw['no_hp']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <input type="text" id="alamat" class="form-control " name="alamat" value="<?= $pgw['alamat']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <input type="text" id="ket" class="form-control " name="ket" value="<?= $pgw['ket']; ?>">
                                            </div>
                                            <div class="col">
                                                <label for="ket2">Keterangan2</label>
                                                <input type="text" id="ket2" class="form-control " name="ket2" value="<?= $pgw['ket2']; ?>">
                                            </div>
                                            <div class="col">
                                                <label for="tmt">TMT</label>
                                                <input type="text" id="tmt" class="form-control " name="tmt" value="<?= $pgw['tmt']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                <?php endforeach; ?>
