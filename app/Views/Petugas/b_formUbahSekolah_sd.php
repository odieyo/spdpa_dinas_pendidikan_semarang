                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                ...
                                                <input type="hidden" name="jenjang" id="jenjang" class="form-control <?= ($validation->hasError('jenjang')) ? 'is-invalid' : ''; ?> " value="SD" placehodler="SD" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                ...
                                                <input type="number" id="guru_katholik" class="form-control <?= ($validation->hasError('guru_khatolik')) ? 'is-invalid' : ''; ?>" name="guru_katholik" value="<?= (old('guru_katholik')) ? old('guru_katholik') : $skl['guru_katholik']; ?>">
                                                <div class="invalid-feedback">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                ...
                                                <div class="invalid-feedback">
                                                    <?= $validation->getError('guru_budha'); ?>
                                                </div>
                                            </div>
                                            <div class="col">
