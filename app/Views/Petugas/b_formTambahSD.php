            ...
            <div class="row mb-2 mt-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url('/petugas/sd/'); ?>#">Sekolah Dasar</a></li>
            ...
            <div class="row">
                <div class="col">
                    <div class="card card-success">
                        ...
                        <div class="card-body">
                            <form action="/petugas/simpanSD" method="post">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <input type="text" id="jenjang" class="form-control " value="Sekolah Dasar" placehodler="Sekolah Dasar" readonly>
                                        </div>
                                        <div class="col">
                                            <label for="kepala_sekolah">Kepala Sekolah</label>
                                            <input type="number" id="kepala_sekolah" class="form-control " name="kepala_sekolah" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <h3 styles="text-align:center;">Kebutuhan</h3>
